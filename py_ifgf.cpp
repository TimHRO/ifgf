...
template <typename OpType, typename T> auto addOp(auto& m, const char* name)
{
...
PYBIND11_MODULE(pyifgf, m)
{
    ...
    num_threads );
    */
    addOp<ModifiedHelmholtzIfgfOperator<3>, std::complex<double>>(m,
                                                                  "MofifiedHelmholtzIfgfOperator");
    ...
    //    addOp<DoubleLayerHelmholtzIfgfOperator<3>,std::complex<double>
    //    >(m,"DoubleLayerHelmholtzIfgfOperator");
