...
template <size_t dim>
class LaplaceIfgfOperator : public IfgfOperator<double, dim, 1, LaplaceIfgfOperator<dim>>
{
  public:
    typedef Eigen::Array<double, dim, Eigen::Dynamic> PointArray;
    typedef Eigen::Vector<double, dim> Point;
    LaplaceIfgfOperator(size_t leafSize, size_t order, size_t n_elem = 1, double tol = -1)
    ...
    inline Eigen::Vector<size_t, dim> elementsForBox(double H, Eigen::Vector<int, dim>,
